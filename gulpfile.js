...
const allPagesPattern = ['HTML/**/*.md', 'CSS/**/*.md', '!HTML/*.md', '!CSS/*.md'];
...
gulp.task('prebuild', ['restore-summary'], function () {
    fillSummary('HTML/SUMMARY.md');
    fillSummary('CSS/SUMMARY.md');
});
...
gulp.task('restore-summary', function () {
    restoreSummary('HTML/SUMMARY.md');
    restoreSummary('CSS/SUMMARY.md');
});
...
gulp.task('prune-left-bar', function () {
    pruneLeftBar('_book/HTML');
    pruneLeftBar('_book/CSS');
});
