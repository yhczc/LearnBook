...
如需更深入地学习 jQuery，请访问我们的 <a rel="noopener noreferrer" target="_blank" href="../jquery/jquery-tutorial.md">jQuery 教程</a>。
...
```javascript
< scriptsrc = "https://cdn.staticfile.org/jquery/3.4.0/jquery.min.js" > < /script>
```
